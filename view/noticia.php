...
<html lang="pt">
    <head>
        ...
        <title>Notícias | Setor de Orçamento e Finanças – HUSM</title>
    ...
    <body class="page-brand">
        ...
        <main class="content">
            <div class="content-heading">
                <div class="container">
                    <div class="row">
                        <h1 class="heading module wow fadeInUp animated"><img src="../sof_files/logo_blue.png" alt="Setor de Orçamento e Finanças – HUSM" /></h1>
                        <div class="text-header module wow fadeInDown animated">
                        ...
                        <div class="card-main">
                            <div class="card-header card-brand">
                                <div class="card-header-side pull-left">
                                    <p class="card-heading">Notícias</p>
                                </div>
                            </div><!--  ./card-header -->
