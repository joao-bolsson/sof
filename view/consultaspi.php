                            ...
                            <form action="printSolicTax.php" method="post">
                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="form-group">
                                        <input class="datepicker-adv form-control" id="dataI" type="text" name="dataI" placeholder="Data Início" required>
                                    </div>
                                    <div class="form-group">
                                        <input class="datepicker-adv form-control" id="dataF" type="text" name="dataF" placeholder="Data Fim" required>
                                    </div>
                                    <div class="form-group form-group-label">
