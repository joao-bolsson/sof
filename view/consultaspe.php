            ...
            <div class="card margin-top-no">
                <div class="card-main">
                    ...
                    <div class="card-inner" style="text-indent: 1.5em; text-align: justify; font-size: 12pt;">
                        ...
                        <p>&nbsp;</p>
                        <p><strong>Item 1 – NE</strong>: é o documento que o hospital envia ao fornecedor e que respalda
                            o pedido do material/serviço. Para consultar esse documento no portal, é necessário digitar
                        ...
                        <p>&nbsp;</p>
                        <p><strong>Item 2 – NS</strong>: é o documento gerado quando da liquidação de notas fiscais no
                            ...
                            disponibilize recursos financeiros para que o pagamento seja realizado. A forma mais fácil
                            de consultar esse documento é por meio da consulta ao Empenho (item 1) destinado ao
                            pagamento da nota fiscal que se deseja consultar. Após clicar-se sobre o número do empenho
                        ...
                        <p>&nbsp;</p>
                        <p><strong>Item 3 – OB:</strong> é o documento que emite a ordem de pagamento. De acordo com a
                            disponibilidade de recursos financeiros, assim que a OB é emitida, em até dois dias úteis o
                            valor é disponibilizado na conta bancária do fornecedor. A forma mais fácil de consultar
                            esse documento é por meio da consulta ao Empenho (item 1) e, logo, clicando-se no número das
                            OBs emitidas a fim de identificar se o pagamento refere-se às notas fiscais citadas nas NSs
                        ...
                        <p><strong>Item 4</strong> – Retenções (DF, DR, GP) são orientadas pela IN 1234/2012. Essas
                            retenções são deduzidas do valor total da nota fiscal, sendo que o valor líquido é liberado
                            ao fornecedor por meio da OB (item 3). Para maiores esclarecimentos quanto às retenções, o
