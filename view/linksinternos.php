...
<head>
	...
	<title>Links Internos | Setor de Orçamento e Finanças – HUSM</title>
...
<main class="content">
  <div class="content-heading">
    <div class="container">
      <div class="row">
        <h1 class="heading module wow bounce animated"><img src="../sof_files/logo_blue.png" alt="Setor de Orçamento e Finanças – HUSM" /></h1>
        <div class="text-header module wow bounce animated">
    ...
    <div class="card-main">
      <div class="card-header card-brand">
        <div class="card-header-side pull-left">
          <p class="card-heading">LINKS INTERNOS</p>
        </div>
      </div><!--  ./card-header -->
      <div class="card-inner" style="text-indent: 1.5em; text-align: justify; font-size: 12pt;">
        <ul>
          <li class="seta-direita"><a href="http://site.ufsm.br/" target="_blank">UFSM</a></li>
          <li class="seta-direita"><a href="http://www.husm.ufsm.br/" target="_blank">HUSM</a></li>
          <li class="seta-direita"><a href="http://ww2.ad.husm.ufsm.br/ssm" target="_blank">Serviço de Manutenção</a> (intranet)</li>
          <li class="seta-direita"><a href="http://ww2.ad.husm.ufsm.br/chamados" target="_blank">Serviço de Informática</a> (intranet)</li>
        </ul>
      </div>
    </div><!-- ./card-main -->
  </div> <!-- ./card -->
