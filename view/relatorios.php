...
<main class="content">
  <div class="content-heading">
    <div class="container">
      <div class="row">
        <h1 class="heading module wow rotateInDownRight animated"><img src="../sof_files/logo_blue.png" alt="Setor de Orçamento e Finanças – HUSM" /></h1>
  ...
  <div class="card margin-top-no">
    <div class="card-main">
      ...
      <div class="card-inner" style="text-indent: 1.5em; text-align: justify; font-size: 12pt;">
        <p>A divulgação das informações aqui disponibilizadas está amparada na <a href="http://www.acessoainformacao.gov.br/assuntos/conheca-seu-direito/principais-aspectos/principais-aspectos" target="_blank">Lei de Acesso à Informação</a> regulamentada pelo <a href="http://www.acessoainformacao.gov.br/assuntos/conheca-seu-direito/a-lei-de-acesso-a-informacao/mapa-do-decreto-no-7.724" target="_blank">Decreto nº 7.724/2012</a>.</p>
        <ul>
