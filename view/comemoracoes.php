...
?>
  ...
  <nav aria-hidden="true" class="menu" id="doc_menu" tabindex="-1">
	...
	<main class="content">
      ...
      <div class="container">
        <div class="row">
          <h1 class="heading module wow fadeIn animated"><img src="../sof_files/logo_blue.png" alt="Setor de Orçamento e Finanças – HUSM" /></h1>
  ...
  <div class="modal fade" id="login" role="dialog">
    <div class="modal-dialog" style="width: 40%;">
      <div class="modal-content">
        ...
        <form id="formLogin" action="javascript:abreModal('#login');" method="post">
