...
$obj_Busca = new Busca();
$id = 0;
if (isset($_SESSION["id_boaspraticas"])) {
	$id = $_SESSION["id_boaspraticas"];
}
?>
<!DOCTYPE html>
<html lang="pt">
<head>
	...
	<title>Boas Práticas | Setor de Orçamento e Finanças – HUSM</title>
...
?>
  ...
  <nav aria-hidden="true" class="menu" id="doc_menu" tabindex="-1">
	...
	<main class="content">
      ...
      <div class="container">
        <div class="row">
          <h1 class="heading module wow fadeInUpBig animated"><img src="../sof_files/logo_blue.png" alt="Setor de Orçamento e Finanças – HUSM" /></h1>
          <div class="text-header module wow fadeInDownBig animated">
              ...
              <div class="card-main">
                <div class="card-header card-brand">
                  <div class="card-header-side pull-left">
                    <p class="card-heading">Boas Práticas</p>
                  </div>
                </div><!--  ./card-header -->
                  ...
                  <div class="card-table">
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody id="noticias">
                          <?php
echo $obj_Busca->getPostagens($_SESSION["id_setor"], 'boaspraticas');
unset($_SESSION["id_boaspraticas"]);
?>
                        </tbody>
                      </table>
                    </div>
