            ...
            <div class="card margin-top-no">
                <div class="card-main">
                    ...
                    <div class="card-inner" style="text-indent: 1.5em; text-align: justify; font-size: 12pt;">
                        ...
                        <ul>
                            <li>Realizar a gestão orçamentária e financeira do hospital, de acordo com as diretrizes da
                                EBSERH sede;
                            </li>
                        ...
                        <p>Nesse viés, e de forma genérica, o SOF é responsável por receber o orçamento e gerenciá-lo de
                            acordo com os pedidos de compras ou solicitações de serviços, autorizando os gastos por meio
