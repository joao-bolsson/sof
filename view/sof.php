...
<main class="content">
  <div class="content-heading">
    <div class="container">
      <div class="row">
        <h1 class="heading module wow slideInUp animated"><img src="../sof_files/logo_blue.png" alt="Setor de Orçamento e Finanças – HUSM" /></h1>
  ...
  <div class="card margin-top-no">
    <div class="card-main">
      ...
      <div class="card-inner" style="text-indent: 1.5em; text-align: justify; font-size: 12pt;">
        ...
        <ul>
          <li>Realizar a gestão orçamentária e financeira do hospital, de acordo com as diretrizes da EBSERH sede;</li>
          <li>Proceder, sem prejuízo da competência atribuída a outras áreas, o acompanhamento gerencial, físico e financeiro da execução orçamentária.</li>
        </ul>
        <p>Nesse viés, e de forma genérica, o SOF é responsável por receber o orçamento e gerenciá-lo de acordo com os pedidos de compras ou solicitações de serviços, autorizando os gastos por meio da emissão de empenhos. Após a prestação dos serviços ou a entrega dos insumos serem comprovadas, o setor recebe as notas fiscais e efetiva o pagamento aos fornecedores, conforme a disponibilidade de recursos financeiros.</p>
        <p><strong>Clique na imagem abaixo para visualizar o Organograma:</strong></p>
        <a style="margin-left: 25%;" href="../uploads/Organograma1.png"><img src="../uploads/Organograma1.png" alt="Organograma" width="600" height="336" class="aligncenter size-medium wp-image-619"></a>
      </div>
    </div><!-- ./card-main -->
  </div> <!-- ./card -->
</div>
