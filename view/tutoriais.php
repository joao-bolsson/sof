...
<head>
	...
	<title>POPs e Tutoriais | Setor de Orçamento e Finanças – HUSM</title>
...
<main class="content">
  <div class="content-heading">
    <div class="container">
      <div class="row">
        <h1 class="heading module wow pulse animated"><img src="../sof_files/logo_blue.png" alt="Setor de Orçamento e Finanças – HUSM" /></h1>
        <div class="text-header module wow pulse animated">
    ...
    <div class="card-main">
      <div class="card-header card-brand">
        <div class="card-header-side pull-left">
          <p class="card-heading">POPS E TUTORIAIS</p>
        </div>
      </div><!--  ./card-header -->
        ...
        <div class="card-table">
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody id="noticias">
                <?php
echo $obj_Busca->getPostagens($_SESSION["id_setor"], 'tutoriais');
