                    ...
                    <div class="card margin-top-no">
                        <div class="card-main">
                            ...
                            <div class="card-inner" style="text-indent: 1.5em; text-align: justify; font-size: 12pt;">
                                <p>Com o objetivo de respaldar a Equipe de Governança do Hospital Universitário de Santa Maria na tomada de decisão, bem como de informar ao público interno e externo acerca do comprometimento orçamentário do hospital, foi criado o I Caderno de Execução Orçamentária do HUSM, referente ao 1º Quadrimestre de 2015, enquanto filial da Empresa Brasileira de Serviços Hospitalares–EBSERH.<br><br>
                                    <strong>O Caderno está estruturado da seguinte forma</strong>:<br><br>
                                    – tabelas com valores comprometidos por solicitante do gasto e descrição da despesa, bem como modalidade de fornecimento – contratos e registro de preços;<br><br>
                                    – valores comprometidos por modalidade de licitação;<br><br>
                                    – gráficos que ilustram totais, percentuais, médias, grupos de maior relevância, perpassando pela taxa de crescimento e a tendência da execução orçamentária do período.<br><br>
                                    <strong>Publicações:</strong>
                                </p>
                                <ul>
                                    <li><a href="../uploads/caderno_execucao_orcamentaria_husm_demo.pdf" target="_blank"><strong>I Caderno de Execução Orçamentária do HUSM – 1º Quadrimestre de 2015 (versão demo)</strong></a></li>
                                </ul>
                                <p><br>
