                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <button id="btnPrintCheck" class="btn btn-primary" type="button" onclick="printChecks()"
                                    disabled><i class="fa fa-print"></i>&nbsp;Imprimir
                            </button>
                            <button class="btn btn-primary" type="button" onclick="abreModal('#loadMoreCustom');"
                                    data-toggle="tooltip" title="Carregar mais pedidos"><i
            ...
            <div class="modal-content">
                ...
                <form action="javascript:loadMore();" method="POST">
                    <div class="modal-body">
                        <small class="label bg-gray">Carrega todos os pedidos entre Limite 1 e Limite 2. A consulta trás
                            todos os pedidos entre tais limites, <br>independente do conteúdo que já estiver na tabela.
                        </small>
                        <div class="form-group">
