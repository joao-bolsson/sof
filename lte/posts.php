            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="javascript:abreModal('#listArquivos');"><i class="fa fa-folder-open"></i> Lista de
                                Arquivos</a></li>
                        <li><a href="javascript:abreModal('#listNoticias');"><i class="fa fa-newspaper-o"></i> Editar
                                Notícia</a></li>
                    </ul>
                </div>
                    ...
                    <form enctype="multipart/form-data" action="../php/geral.php" method="post"
                        ...
                        <div class="box-footer">
                            <div class="btn-group" style="width: 100%;">
                                <button id="btnLimpa" class="btn btn-default" type="reset" style="width: 49%;"
                                        onclick="limpaTela();"><i class="fa fa-undo"></i>&nbsp;Limpar
                                </button>
                                <button class="btn btn-primary" type="submit" style="width: 50%;"><i
                                            class="fa fa-send"></i> Publicar
                                </button>
                            </div>
                        </div>
                    </form>
