                        ...
                        <form action="../php/geral.php" method="post">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>Nome</label>
                                    <input class="form-control" name="nameUser" type="text" value="" required>
                                </div>
                                <div class="form-group">
                                    <label>Entrada</label>
                                    <input class="form-control" name="emailUser" type="text" value="" required>
                                </div>
                                <div class="form-group">
                                    <label>Saída</label>
                                    <input class="form-control" name="saida" type="text" required>
                                </div>
                            </div>
