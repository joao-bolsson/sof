                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="id_item_processo" step="1"
                                                           class="form-control" placeholder="Id Item Processo">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="number" name="id_item_contrato" step="1"
                                                           class="form-control" placeholder="Id Item Contrato">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="cod_despesa" maxlength="15"
                                                           class="form-control" placeholder="Código Despesa">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="descr_despesa" maxlength="100"
                                                           class="form-control" placeholder="Descrição Despesa">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="descr_tipo_doc" maxlength="80"
                                                           class="form-control" placeholder="Descrição Tipo Doc">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="num_contrato" maxlength="15"
                                                           class="form-control" placeholder="Número do Contrato">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="num_processo" maxlength="20"
                                            ...
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="descr_mod_compra" maxlength="50"
                                                           class="form-control" placeholder="Descrição Mod Compra">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="num_licitacao" maxlength="15"
                                                           class="form-control" placeholder="Número da Licitação">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="dt_inicio" maxlength="15"
                                                           class="form-control date" placeholder="Data Início">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="dt_fim" maxlength="15"
                                                           class="form-control date" placeholder="Data Fim">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="dt_geracao" maxlength="15"
                                                           class="form-control date" placeholder="Data Geração">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="cgc_fornecedor" maxlength="20"
                                                           class="form-control" placeholder="CGC Fornecedor">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="nome_fornecedor" maxlength="50"
                                            ...
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="num_extrato" maxlength="20"
                                                           class="form-control" placeholder="Número do Extrato">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="cod_estruturado" maxlength="20"
                                                           class="form-control" placeholder="Código Estruturado">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="nome_unidade" maxlength="100"
                                                           class="form-control" placeholder="Nome da Unidade">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="cod_reduzido" maxlength="20"
                                                           class="form-control" placeholder="Código Reduzido">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="complemento_item" maxlength="500"
                                                           class="form-control" placeholder="Complemento do Item">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="number" name="id_extrato_contr" step="1"
                                                           class="form-control" placeholder="Id Extrato Contrato">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="number" name="vl_unitario" step="0.001"
                                            ...
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="number" name="qt_contrato" step="1"
                                                           class="form-control" placeholder="Quantidade Contrato">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="number" name="vl_contrato" step="0.001"
                                                           class="form-control" placeholder="Valor Contrato">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="number" name="qt_utilizado" step="1"
                                                           class="form-control" placeholder="Quantidade Utilizada">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="number" name="vl_utilizado" step="0.001"
                                                           class="form-control" placeholder="Valor Utilizado">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="number" name="qt_saldo" step="1" class="form-control"
                                                           placeholder="Quantidade Saldo">
                                                </div>
                                            </div>
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="number" name="vl_saldo" step="0.001"
                                                           class="form-control" placeholder="Valor Saldo">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="number" name="id_unidade" step="1" class="form-control"
                                            ...
                                            <div class="col-xs-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="number" name="ano_orcamento" step="1" min="2000"
                                                           class="form-control" placeholder="Ano Orçamento">
                                                </div>
                                            </div>
                                            <div class="col-xs-6">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                                    <input type="text" name="seq_item_processo" maxlength="20"
                                                           class="form-control" placeholder="Seq Item Processo">
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- /.box-body -->
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="num_processo" name="num_processo"
                                                   type="text" required>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <label>Estante</label>
                                            <input class="form-control" id="estante" name="estante" type="text"
                                                   required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="prateleira" name="prateleira" type="text"
                                                   required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control date" id="entrada" name="entrada" type="text"
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control date" id="saida" name="saida" type="text"
                                                   maxlength="10">
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="compItem" name="complemento" required
                                                      rows="5"></textarea>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="codDespesa" name="cod_despesa" type="text"
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="codReduzido" name="cod_reduzido" type="text"
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <label>Data Fim</label>
                                            <input class="form-control" id="dtFim" name="dt_fim" type="text"
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="vlUnitario" name="vl_unitario" type="number"
                                                   step="0.001" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="qtContrato" name="qt_contrato" type="number"
                                                   required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="vlContrato" name="vl_contrato" type="number"
                                                   step="0.001" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="qtUtilizada" name="qt_utilizada"
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="vlUtilizado" name="vl_utilizado"
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="qtSaldo" name="qt_saldo" type="number"
                                                   required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="vlSaldo" name="vl_saldo" type="number"
                                                   step="0.001" required>
                                        </div>
                                    </td>
                                </tr>
